...
if not defined TARGET_PROJECT_DEV_SERVER_PORT (set TARGET_PROJECT_DEV_SERVER_PORT=3001)
if not defined TARGET_PROJECT_DEV_SERVER_HOSTNAME (set TARGET_PROJECT_DEV_SERVER_HOSTNAME=mod)
